...
const DashBoardPage = () => {
  ...
  const { publicKey, balance } = useBalance();
  ...
  console.log("public key is ", publicKey?.toString())
  // console.log("user public key is ", userPublicKey?.toString())
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted/50 p-3 rounded-lg">
                  <p className="text-sm mb-2">
                    Refer friends and earn 0.001 SOL for each new user who
